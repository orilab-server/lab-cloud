...
import ConfirmRequestsModal from '@/app/admin/(authorized)/_components/Misc/ConfirmRequestsModal';
import { useAdminLogout } from '@/app/admin/(authorized)/_hooks/useAdminLogout';
...
const SideBar = ({ registerRequests }: Props) => {
