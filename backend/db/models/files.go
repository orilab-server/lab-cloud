...
type File struct {
	...
	DirID     string    `boil:"dir_id" json:"dir_id" toml:"dir_id" yaml:"dir_id"`
...
var FileWhere = struct {
	...
	ID:        whereHelperstring{field: "\"files\".\"id\""},
	UserID:    whereHelperstring{field: "\"files\".\"user_id\""},
	DirID:     whereHelperstring{field: "\"files\".\"dir_id\""},
	Location:  whereHelperstring{field: "\"files\".\"location\""},
...
var (
	fileAllColumns            = []string{"id", "user_id", "dir_id", "location", "name", "size", "created_at", "updated_at"}
	fileColumnsWithoutDefault = []string{"user_id", "dir_id", "location", "name", "size"}
...
func (o *File) Dir(mods ...qm.QueryMod) dirQuery {
...
func (o *File) Trashes(mods ...qm.QueryMod) trashQuery {
...
func (fileL) LoadDir(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFile interface{}, mods queries.Applicator) error {
	var slice []*File
	var object *File
...
func (fileL) LoadTrashes(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFile interface{}, mods queries.Applicator) error {
	var slice []*File
	var object *File
	...
	query := NewQuery(qm.From(`trashes`), qm.WhereIn(`trashes.file_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
// SetDir of the file to the related item.
// Sets o.R.Dir to related.
// Adds o to related.R.Files.
func (o *File) SetDir(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Dir) error {
	var err error
	if insert {
...
func (o *File) AddTrashes(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Trash) error {
	var err error
...
// Sets o.R.File's Trashes accordingly.
// Replaces o.R.Trashes with related.
// Sets related.R.File's Trashes accordingly.
func (o *File) SetTrashes(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Trash) error {
	query := "update \"trashes\" set \"file_id\" = null where \"file_id\" = $1"
...
// Sets related.R.File.
func (o *File) RemoveTrashes(ctx context.Context, exec boil.ContextExecutor, related ...*Trash) error {
	var err error
	for _, rel := range related {
		queries.SetScanner(&rel.FileID, nil)
		if rel.R != nil {
