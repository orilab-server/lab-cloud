...
func testFileToManyTrashes(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := FileSlice{&a}
	if err = a.L.LoadTrashes(ctx, tx, false, (*[]*File)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testFileToManyAddOpTrashes(t *testing.T) {
	var err error
...
func testFileToManySetOpTrashes(t *testing.T) {
	var err error
...
func testFileToManyRemoveOpTrashes(t *testing.T) {
	var err error
...
func testFileToOneDirUsingDir(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = local.L.LoadDir(ctx, tx, false, (*[]*File)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.Dir == nil {
...
func testFileToOneUserUsingUser(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := FileSlice{&local}
	if err = local.L.LoadUser(ctx, tx, false, (*[]*File)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.User == nil {
		t.Error("struct should have been eager loaded")
...
func testFileToOneSetOpDirUsingDir(t *testing.T) {
	var err error
...
func testFileToOneSetOpUserUsingUser(t *testing.T) {
	var err error
...
var (
	fileDBTypes = map[string]string{`ID`: `uuid`, `UserID`: `uuid`, `DirID`: `uuid`, `Location`: `text`, `Name`: `text`, `Size`: `bigint`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
