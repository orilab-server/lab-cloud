...
func (r *reviewR) GetRevieweds() ReviewedSlice {
	if r == nil {
		return nil
	}
	return r.Revieweds
...
func (o *Review) Revieweds(mods ...qm.QueryMod) reviewedQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`reviewed`.`review_id`=?", o.ID),
	)
...
func (reviewL) LoadRevieweds(ctx context.Context, e boil.ContextExecutor, singular bool, maybeReview interface{}, mods queries.Applicator) error {
	var slice []*Review
	var object *Review
	...
	query := NewQuery(
		qm.From(`reviewed`),
		qm.WhereIn(`reviewed.review_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Review) AddRevieweds(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Reviewed) error {
	var err error
